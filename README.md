...
- Tener el puerto 8000 libre (puede cambiarse a 8080 si es necesario).
...
Después de ejecutar los comandos, verias el siguiente mensaje
...
Signica que está todo funcionando.
...
Cualquier cambio que guardes en los archivos `.py` se detecta automáticamente por uvicorn.
